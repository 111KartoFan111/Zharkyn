...
const reviews = [
  ...
  },
  {
    ...
    vehicle: 'CarTypeImg/Trailer.svg'
  }
];
                    ...
                    <div className='ReviewsGap' key={index}>
                        <div className='ReviewsItem'>
                            <div className='ReviewsItemTitle'>
                                <h3>{review.name}</h3>
                                <img src="public/img/chitat.svg" alt="Quote icon" />
                            </div>
                            ...
                            <div className='ReviewsItemfooter'>
                                <div className='ReviewsItemImg'>
                                    <img src={`public/img/${review.vehicle}`} alt="Vehicle type" />
                                </div>
                                <div className='ReviewsItemFooter'>
                                    <p>{review.name}</p>
                                </div>
